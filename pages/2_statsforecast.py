...
if selected_stock:
    ...
    if stock_history.empty:
        ...
        st.header(f"{selected_stock} Stock Price - {selected_time} - {selected_coverage}% PIs with AutoARIMA")
        ...
        season_length = 21
        models1 = [AutoARIMA(season_length=season_length)]
        sf = StatsForecast(models=models1, freq='B', n_jobs=-1)
        sf.fit(train)
        levels = [selected_coverage]
