...
ADAPTER_DIR = "Qwen3-4B_Instruct-medical"
BASE_MODEL = "unsloth/Qwen3-4B-Instruct-2507"
MERGED_DIR = "qwen3-4B-medical-merged"
...
def main():
    ...
    print("  python llama.cpp/convert_hf_to_gguf.py qwen3-4B-medical-merged --outfile Qwen3-4B_Instruct-medical.gguf --outtype q8_0")
