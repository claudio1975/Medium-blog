...
ADAPTER_DIR = "Qwen3-8B-medical"
BASE_MODEL = "unsloth/Qwen3-8B"
MERGED_DIR = "qwen3-8B-medical-merged"
...
def main():
    ...
    print("  python llama.cpp/convert_hf_to_gguf.py qwen3-8B-medical-merged --outfile Qwen3-8B-medical.gguf --outtype q8_0")
